...
namespace fs_attributes_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_attributes.glsl --reflection --output shaders/compiled/osx/fs_attributes-shader.cs --slang metal_macos -f sokol_csharp
