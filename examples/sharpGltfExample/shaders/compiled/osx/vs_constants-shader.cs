...
namespace vs_constants_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/vs_constants.glsl --reflection --output shaders/compiled/osx/vs_constants-shader.cs --slang metal_macos -f sokol_csharp
