...
namespace structures_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/structures.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/osx/structures-shader-skinning.cs --slang metal_macos -f sokol_csharp
