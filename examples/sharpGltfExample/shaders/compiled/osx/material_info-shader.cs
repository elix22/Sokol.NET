...
namespace material_info_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/material_info.glsl --reflection --output shaders/compiled/osx/material_info-shader.cs --slang metal_macos -f sokol_csharp
