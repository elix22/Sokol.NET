...
namespace vs_attributes_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/vs_attributes.glsl --reflection --output shaders/compiled/osx/vs_attributes-shader.cs --slang metal_macos -f sokol_csharp
