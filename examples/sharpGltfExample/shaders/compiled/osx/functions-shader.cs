...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/functions.glsl --reflection --output shaders/compiled/osx/functions-shader.cs --slang metal_macos -f sokol_csharp
