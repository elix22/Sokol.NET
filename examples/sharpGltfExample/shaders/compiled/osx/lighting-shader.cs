...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/lighting.glsl --reflection --output shaders/compiled/osx/lighting-shader.cs --slang metal_macos -f sokol_csharp
