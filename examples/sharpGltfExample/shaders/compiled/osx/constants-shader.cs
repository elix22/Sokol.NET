...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/constants.glsl --reflection --output shaders/compiled/osx/constants-shader.cs --slang metal_macos -f sokol_csharp
