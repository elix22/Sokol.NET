...
namespace material_info_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/material_info.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/osx/material_info-shader-skinning.cs --slang metal_macos -f sokol_csharp
