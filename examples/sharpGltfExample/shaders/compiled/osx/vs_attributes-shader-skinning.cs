...
namespace vs_attributes_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/vs_attributes.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/osx/vs_attributes-shader-skinning.cs --slang metal_macos -f sokol_csharp
