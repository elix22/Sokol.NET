...
namespace vs_uniforms_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/vs_uniforms.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/osx/vs_uniforms-shader-skinning.cs --slang metal_macos -f sokol_csharp
