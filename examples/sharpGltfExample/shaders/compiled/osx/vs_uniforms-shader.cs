...
namespace vs_uniforms_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/vs_uniforms.glsl --reflection --output shaders/compiled/osx/vs_uniforms-shader.cs --slang metal_macos -f sokol_csharp
