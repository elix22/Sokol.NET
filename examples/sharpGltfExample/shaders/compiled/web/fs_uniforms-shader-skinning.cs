...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_uniforms.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/web/fs_uniforms-shader-skinning.cs --slang glsl300es -f sokol_csharp
