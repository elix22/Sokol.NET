...
namespace fs_lighting_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_lighting.glsl --reflection --output shaders/compiled/android/fs_lighting-shader.cs --slang glsl300es -f sokol_csharp
