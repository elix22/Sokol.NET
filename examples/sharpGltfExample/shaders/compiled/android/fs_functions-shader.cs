...
namespace fs_functions_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_functions.glsl --reflection --output shaders/compiled/android/fs_functions-shader.cs --slang glsl300es -f sokol_csharp
