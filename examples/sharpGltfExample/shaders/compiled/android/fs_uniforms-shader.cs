...
namespace fs_uniforms_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_uniforms.glsl --reflection --output shaders/compiled/android/fs_uniforms-shader.cs --slang glsl300es -f sokol_csharp
