...
namespace brdf_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/brdf.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/android/brdf-shader-skinning.cs --slang glsl300es -f sokol_csharp
