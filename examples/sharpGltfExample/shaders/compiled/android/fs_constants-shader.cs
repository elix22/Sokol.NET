...
namespace fs_constants_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_constants.glsl --reflection --output shaders/compiled/android/fs_constants-shader.cs --slang glsl300es -f sokol_csharp
