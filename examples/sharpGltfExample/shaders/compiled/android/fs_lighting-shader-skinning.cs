...
namespace fs_lighting_shader_skinning_cs_skinning {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fs_lighting.glsl --defines SKINNING --module skinning --reflection --output shaders/compiled/android/fs_lighting-shader-skinning.cs --slang glsl300es -f sokol_csharp
