...
namespace debugtext_context_sapp_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/debugtext-context-sapp.glsl --output shaders/compiled/web/debugtext-context-sapp-shader.cs --slang glsl300es -f sokol_csharp
        ...
        Bindings:
            ...
            Sampler 'smp':
                ...
                Bind slot: SMP_smp => 0
    */
    public const int ATTR_debugtext_context_pos = 0;
    public const int ATTR_debugtext_context_texcoord0 = 1;
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    static readonly byte[] vs_source_glsl300es = {
            ...
            0x78,    0x2c,    0x20,    0x31,    0x2e,    0x30,    0x20,    0x2d,    0x20,    0x74,    0x65,    0x78,    0x63,    0x6f,    0x6f,    0x72,    
    ...
    */
    ...
    public static unsafe sg_shader_desc debugtext_context_shader_desc(sg_backend backend) {
        if (backend == SG_BACKEND_GLES3) {
            ...
            desc.label = "debugtext_context_shader";
            return desc;
        }
