...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/shadows-sapp.glsl --output shaders/compiled/ios/shadows-sapp-shader.cs --slang metal_ios -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    static readonly byte[] vs_shadow_source_metal_ios = {
    ...
    */
    static readonly byte[] fs_shadow_source_metal_ios = {
    ...
    */
    static readonly byte[] vs_display_source_metal_ios = {
            0x23,    0x69,    0x6e,    0x63,    0x6c,    0x75,    0x64,    0x65,    0x20,    0x3c,    0x6d,    0x65,    0x74,    0x61,    0x6c,    0x5f,    
            0x73,    0x74,    0x64,    0x6c,    0x69,    0x62,    0x3e,    0x0a,    0x23,    0x69,    0x6e,    0x63,    0x6c,    0x75,    0x64,    0x65,    
            0x20,    0x3c,    0x73,    0x69,    0x6d,    0x64,    0x2f,    0x73,    0x69,    0x6d,    0x64,    0x2e,    0x68,    0x3e,    0x0a,    0x0a,    
            0x75,    0x73,    0x69,    0x6e,    0x67,    0x20,    0x6e,    0x61,    0x6d,    0x65,    0x73,    0x70,    0x61,    0x63,    0x65,    0x20,    
    ...
    */
    static readonly byte[] fs_display_source_metal_ios = {
            0x23,    0x70,    0x72,    0x61,    0x67,    0x6d,    0x61,    0x20,    0x63,    0x6c,    0x61,    0x6e,    0x67,    0x20,    0x64,    0x69,    
            0x61,    0x67,    0x6e,    0x6f,    0x73,    0x74,    0x69,    0x63,    0x20,    0x69,    0x67,    0x6e,    0x6f,    0x72,    0x65,    0x64,    
            0x20,    0x22,    0x2d,    0x57,    0x6d,    0x69,    0x73,    0x73,    0x69,    0x6e,    0x67,    0x2d,    0x70,    0x72,    0x6f,    0x74,    
            0x6f,    0x74,    0x79,    0x70,    0x65,    0x73,    0x22,    0x0a,    0x0a,    0x23,    0x69,    0x6e,    0x63,    0x6c,    0x75,    0x64,    
    ...
    */
    ...
    public static unsafe sg_shader_desc display_shader_desc(sg_backend backend) {
        if (backend == SG_BACKEND_METAL_IOS) {
            sg_shader_desc desc = default(sg_shader_desc);
            desc.vertex_func.source = System.Text.Encoding.UTF8.GetString(vs_display_source_metal_ios);
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = System.Text.Encoding.UTF8.GetString(fs_display_source_metal_ios);
            desc.fragment_func.entry = "main0";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
    ...
    public static unsafe sg_shader_desc shadow_shader_desc(sg_backend backend) {
        if (backend == SG_BACKEND_METAL_IOS) {
            sg_shader_desc desc = default(sg_shader_desc);
            desc.vertex_func.source = System.Text.Encoding.UTF8.GetString(vs_shadow_source_metal_ios);
            desc.vertex_func.entry = "main0";
            desc.fragment_func.source = System.Text.Encoding.UTF8.GetString(fs_shadow_source_metal_ios);
            desc.fragment_func.entry = "main0";
            desc.attrs[0].base_type = SG_SHADERATTRBASETYPE_FLOAT;
            desc.uniform_blocks[0].stage = SG_SHADERSTAGE_VERTEX;
            desc.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
