...
namespace fontstash_layers_sapp_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/fontstash-layers-sapp.glsl --output shaders/compiled/web/fontstash-layers-sapp-shader.cs --slang glsl300es -f sokol_csharp
        ...
        Bindings:
    */
    public const int ATTR_triangle_position = 0;
    public const int ATTR_triangle_color0 = 1;
    /*
        #version 300 es
    ...
    */
    ...
    public static unsafe sg_shader_desc triangle_shader_desc(sg_backend backend) {
