...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/imgui-usercallback-sapp.glsl --output shaders/compiled/android/imgui-usercallback-sapp-shader.cs --slang glsl300es -f sokol_csharp
