...
namespace imgui_usercallback_sapp_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/imgui-usercallback-sapp.glsl --output shaders/compiled/ios/imgui-usercallback-sapp-shader.cs --slang metal_ios -f sokol_csharp
    ...
    */
    public const int ATTR_scene_position = 0;
    public const int ATTR_scene_color0 = 1;
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static unsafe sg_shader_desc scene_shader_desc(sg_backend backend) {
