...
// end include: preamble.js
  ...
  /** @type {function(...*):?} */
  function _ma_libopus_get_cursor_in_pcm_frames(
  ) {
  abort('missing function: ma_libopus_get_cursor_in_pcm_frames');
  }
  _ma_libopus_get_cursor_in_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_get_data_format(
  ) {
  abort('missing function: ma_libopus_get_data_format');
  }
  _ma_libopus_get_data_format.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_get_length_in_pcm_frames(
  ) {
  abort('missing function: ma_libopus_get_length_in_pcm_frames');
  }
  _ma_libopus_get_length_in_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_init(
  ) {
  abort('missing function: ma_libopus_init');
  }
  _ma_libopus_init.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_init_file(
  ) {
  abort('missing function: ma_libopus_init_file');
  }
  _ma_libopus_init_file.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_read_pcm_frames(
  ) {
  abort('missing function: ma_libopus_read_pcm_frames');
  }
  _ma_libopus_read_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_seek_to_pcm_frame(
  ) {
  abort('missing function: ma_libopus_seek_to_pcm_frame');
  }
  _ma_libopus_seek_to_pcm_frame.stub = true;

  /** @type {function(...*):?} */
  function _ma_libopus_uninit(
  ) {
  abort('missing function: ma_libopus_uninit');
  }
  _ma_libopus_uninit.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_get_cursor_in_pcm_frames(
  ) {
  abort('missing function: ma_libvorbis_get_cursor_in_pcm_frames');
  }
  _ma_libvorbis_get_cursor_in_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_get_data_format(
  ) {
  abort('missing function: ma_libvorbis_get_data_format');
  }
  _ma_libvorbis_get_data_format.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_get_length_in_pcm_frames(
  ) {
  abort('missing function: ma_libvorbis_get_length_in_pcm_frames');
  }
  _ma_libvorbis_get_length_in_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_init(
  ) {
  abort('missing function: ma_libvorbis_init');
  }
  _ma_libvorbis_init.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_init_file(
  ) {
  abort('missing function: ma_libvorbis_init_file');
  }
  _ma_libvorbis_init_file.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_read_pcm_frames(
  ) {
  abort('missing function: ma_libvorbis_read_pcm_frames');
  }
  _ma_libvorbis_read_pcm_frames.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_seek_to_pcm_frame(
  ) {
  abort('missing function: ma_libvorbis_seek_to_pcm_frame');
  }
  _ma_libvorbis_seek_to_pcm_frame.stub = true;

  /** @type {function(...*):?} */
  function _ma_libvorbis_uninit(
  ) {
  abort('missing function: ma_libvorbis_uninit');
  }
  _ma_libvorbis_uninit.stub = true;
...
var wasmImports = {
  ...
  /** @export */
  ma_libopus_get_cursor_in_pcm_frames: _ma_libopus_get_cursor_in_pcm_frames,
  /** @export */
  ma_libopus_get_data_format: _ma_libopus_get_data_format,
  /** @export */
  ma_libopus_get_length_in_pcm_frames: _ma_libopus_get_length_in_pcm_frames,
  /** @export */
  ma_libopus_init: _ma_libopus_init,
  /** @export */
  ma_libopus_init_file: _ma_libopus_init_file,
  /** @export */
  ma_libopus_read_pcm_frames: _ma_libopus_read_pcm_frames,
  /** @export */
  ma_libopus_seek_to_pcm_frame: _ma_libopus_seek_to_pcm_frame,
  /** @export */
  ma_libopus_uninit: _ma_libopus_uninit,
  /** @export */
  ma_libvorbis_get_cursor_in_pcm_frames: _ma_libvorbis_get_cursor_in_pcm_frames,
  /** @export */
  ma_libvorbis_get_data_format: _ma_libvorbis_get_data_format,
  /** @export */
  ma_libvorbis_get_length_in_pcm_frames: _ma_libvorbis_get_length_in_pcm_frames,
  /** @export */
  ma_libvorbis_init: _ma_libvorbis_init,
  /** @export */
  ma_libvorbis_init_file: _ma_libvorbis_init_file,
  /** @export */
  ma_libvorbis_read_pcm_frames: _ma_libvorbis_read_pcm_frames,
  /** @export */
  ma_libvorbis_seek_to_pcm_frame: _ma_libvorbis_seek_to_pcm_frame,
  /** @export */
  ma_libvorbis_uninit: _ma_libvorbis_uninit,
  /** @export */
...
var _ma_log_callback_init_internal = Module['_ma_log_callback_init_internal'] = createExportWrapper('ma_log_callback_init_internal');
var _ma_biquad_config_init_internal = Module['_ma_biquad_config_init_internal'] = createExportWrapper('ma_biquad_config_init_internal');
var _ma_lpf1_config_init_internal = Module['_ma_lpf1_config_init_internal'] = createExportWrapper('ma_lpf1_config_init_internal');
var _ma_lpf2_config_init_internal = Module['_ma_lpf2_config_init_internal'] = createExportWrapper('ma_lpf2_config_init_internal');
var _ma_lpf_config_init_internal = Module['_ma_lpf_config_init_internal'] = createExportWrapper('ma_lpf_config_init_internal');
var _ma_hpf1_config_init_internal = Module['_ma_hpf1_config_init_internal'] = createExportWrapper('ma_hpf1_config_init_internal');
var _ma_hpf2_config_init_internal = Module['_ma_hpf2_config_init_internal'] = createExportWrapper('ma_hpf2_config_init_internal');
var _ma_hpf_config_init_internal = Module['_ma_hpf_config_init_internal'] = createExportWrapper('ma_hpf_config_init_internal');
var _ma_bpf2_config_init_internal = Module['_ma_bpf2_config_init_internal'] = createExportWrapper('ma_bpf2_config_init_internal');
var _ma_bpf_config_init_internal = Module['_ma_bpf_config_init_internal'] = createExportWrapper('ma_bpf_config_init_internal');
var _ma_notch2_config_init_internal = Module['_ma_notch2_config_init_internal'] = createExportWrapper('ma_notch2_config_init_internal');
var _ma_peak2_config_init_internal = Module['_ma_peak2_config_init_internal'] = createExportWrapper('ma_peak2_config_init_internal');
var _ma_loshelf2_config_init_internal = Module['_ma_loshelf2_config_init_internal'] = createExportWrapper('ma_loshelf2_config_init_internal');
var _ma_hishelf2_config_init_internal = Module['_ma_hishelf2_config_init_internal'] = createExportWrapper('ma_hishelf2_config_init_internal');
var _ma_delay_config_init_internal = Module['_ma_delay_config_init_internal'] = createExportWrapper('ma_delay_config_init_internal');
var _ma_gainer_config_init_internal = Module['_ma_gainer_config_init_internal'] = createExportWrapper('ma_gainer_config_init_internal');
var _ma_panner_config_init_internal = Module['_ma_panner_config_init_internal'] = createExportWrapper('ma_panner_config_init_internal');
var _ma_fader_config_init_internal = Module['_ma_fader_config_init_internal'] = createExportWrapper('ma_fader_config_init_internal');
var _ma_spatializer_listener_config_init_internal = Module['_ma_spatializer_listener_config_init_internal'] = createExportWrapper('ma_spatializer_listener_config_init_internal');
var _ma_spatializer_listener_get_position_internal = Module['_ma_spatializer_listener_get_position_internal'] = createExportWrapper('ma_spatializer_listener_get_position_internal');
var _ma_spatializer_listener_get_direction_internal = Module['_ma_spatializer_listener_get_direction_internal'] = createExportWrapper('ma_spatializer_listener_get_direction_internal');
var _ma_spatializer_listener_get_velocity_internal = Module['_ma_spatializer_listener_get_velocity_internal'] = createExportWrapper('ma_spatializer_listener_get_velocity_internal');
var _ma_spatializer_listener_get_world_up_internal = Module['_ma_spatializer_listener_get_world_up_internal'] = createExportWrapper('ma_spatializer_listener_get_world_up_internal');
var _ma_spatializer_config_init_internal = Module['_ma_spatializer_config_init_internal'] = createExportWrapper('ma_spatializer_config_init_internal');
var _ma_spatializer_get_position_internal = Module['_ma_spatializer_get_position_internal'] = createExportWrapper('ma_spatializer_get_position_internal');
var _ma_spatializer_get_direction_internal = Module['_ma_spatializer_get_direction_internal'] = createExportWrapper('ma_spatializer_get_direction_internal');
var _ma_spatializer_get_velocity_internal = Module['_ma_spatializer_get_velocity_internal'] = createExportWrapper('ma_spatializer_get_velocity_internal');
var _ma_linear_resampler_config_init_internal = Module['_ma_linear_resampler_config_init_internal'] = createExportWrapper('ma_linear_resampler_config_init_internal');
var _ma_resampler_config_init_internal = Module['_ma_resampler_config_init_internal'] = createExportWrapper('ma_resampler_config_init_internal');
var _ma_channel_converter_config_init_internal = Module['_ma_channel_converter_config_init_internal'] = createExportWrapper('ma_channel_converter_config_init_internal');
var _ma_data_converter_config_init_default_internal = Module['_ma_data_converter_config_init_default_internal'] = createExportWrapper('ma_data_converter_config_init_default_internal');
var _ma_data_converter_config_init_internal = Module['_ma_data_converter_config_init_internal'] = createExportWrapper('ma_data_converter_config_init_internal');
var _ma_data_source_config_init_internal = Module['_ma_data_source_config_init_internal'] = createExportWrapper('ma_data_source_config_init_internal');
var _ma_audio_buffer_config_init_internal = Module['_ma_audio_buffer_config_init_internal'] = createExportWrapper('ma_audio_buffer_config_init_internal');
var _ma_paged_audio_buffer_config_init_internal = Module['_ma_paged_audio_buffer_config_init_internal'] = createExportWrapper('ma_paged_audio_buffer_config_init_internal');
var _ma_slot_allocator_config_init_internal = Module['_ma_slot_allocator_config_init_internal'] = createExportWrapper('ma_slot_allocator_config_init_internal');
var _ma_job_init_internal = Module['_ma_job_init_internal'] = createExportWrapper('ma_job_init_internal');
var _ma_job_queue_config_init_internal = Module['_ma_job_queue_config_init_internal'] = createExportWrapper('ma_job_queue_config_init_internal');
var _ma_device_job_thread_config_init_internal = Module['_ma_device_job_thread_config_init_internal'] = createExportWrapper('ma_device_job_thread_config_init_internal');
var _ma_context_config_init_internal = Module['_ma_context_config_init_internal'] = createExportWrapper('ma_context_config_init_internal');
var _ma_device_config_init_internal = Module['_ma_device_config_init_internal'] = createExportWrapper('ma_device_config_init_internal');
var _ma_decoding_backend_config_init_internal = Module['_ma_decoding_backend_config_init_internal'] = createExportWrapper('ma_decoding_backend_config_init_internal');
var _ma_decoder_config_init_internal = Module['_ma_decoder_config_init_internal'] = createExportWrapper('ma_decoder_config_init_internal');
var _ma_decoder_config_init_default_internal = Module['_ma_decoder_config_init_default_internal'] = createExportWrapper('ma_decoder_config_init_default_internal');
var _ma_encoder_config_init_internal = Module['_ma_encoder_config_init_internal'] = createExportWrapper('ma_encoder_config_init_internal');
var _ma_waveform_config_init_internal = Module['_ma_waveform_config_init_internal'] = createExportWrapper('ma_waveform_config_init_internal');
var _ma_pulsewave_config_init_internal = Module['_ma_pulsewave_config_init_internal'] = createExportWrapper('ma_pulsewave_config_init_internal');
var _ma_noise_config_init_internal = Module['_ma_noise_config_init_internal'] = createExportWrapper('ma_noise_config_init_internal');
var _ma_resource_manager_pipeline_notifications_init_internal = Module['_ma_resource_manager_pipeline_notifications_init_internal'] = createExportWrapper('ma_resource_manager_pipeline_notifications_init_internal');
var _ma_resource_manager_data_source_config_init_internal = Module['_ma_resource_manager_data_source_config_init_internal'] = createExportWrapper('ma_resource_manager_data_source_config_init_internal');
var _ma_resource_manager_config_init_internal = Module['_ma_resource_manager_config_init_internal'] = createExportWrapper('ma_resource_manager_config_init_internal');
var _ma_node_config_init_internal = Module['_ma_node_config_init_internal'] = createExportWrapper('ma_node_config_init_internal');
var _ma_node_graph_config_init_internal = Module['_ma_node_graph_config_init_internal'] = createExportWrapper('ma_node_graph_config_init_internal');
var _ma_data_source_node_config_init_internal = Module['_ma_data_source_node_config_init_internal'] = createExportWrapper('ma_data_source_node_config_init_internal');
var _ma_splitter_node_config_init_internal = Module['_ma_splitter_node_config_init_internal'] = createExportWrapper('ma_splitter_node_config_init_internal');
var _ma_biquad_node_config_init_internal = Module['_ma_biquad_node_config_init_internal'] = createExportWrapper('ma_biquad_node_config_init_internal');
var _ma_lpf_node_config_init_internal = Module['_ma_lpf_node_config_init_internal'] = createExportWrapper('ma_lpf_node_config_init_internal');
var _ma_hpf_node_config_init_internal = Module['_ma_hpf_node_config_init_internal'] = createExportWrapper('ma_hpf_node_config_init_internal');
var _ma_bpf_node_config_init_internal = Module['_ma_bpf_node_config_init_internal'] = createExportWrapper('ma_bpf_node_config_init_internal');
var _ma_notch_node_config_init_internal = Module['_ma_notch_node_config_init_internal'] = createExportWrapper('ma_notch_node_config_init_internal');
var _ma_peak_node_config_init_internal = Module['_ma_peak_node_config_init_internal'] = createExportWrapper('ma_peak_node_config_init_internal');
var _ma_loshelf_node_config_init_internal = Module['_ma_loshelf_node_config_init_internal'] = createExportWrapper('ma_loshelf_node_config_init_internal');
var _ma_hishelf_node_config_init_internal = Module['_ma_hishelf_node_config_init_internal'] = createExportWrapper('ma_hishelf_node_config_init_internal');
var _ma_delay_node_config_init_internal = Module['_ma_delay_node_config_init_internal'] = createExportWrapper('ma_delay_node_config_init_internal');
var _ma_engine_node_config_init_internal = Module['_ma_engine_node_config_init_internal'] = createExportWrapper('ma_engine_node_config_init_internal');
var _ma_sound_config_init_internal = Module['_ma_sound_config_init_internal'] = createExportWrapper('ma_sound_config_init_internal');
var _ma_sound_config_init_2_internal = Module['_ma_sound_config_init_2_internal'] = createExportWrapper('ma_sound_config_init_2_internal');
var _ma_sound_group_config_init_internal = Module['_ma_sound_group_config_init_internal'] = createExportWrapper('ma_sound_group_config_init_internal');
var _ma_sound_group_config_init_2_internal = Module['_ma_sound_group_config_init_2_internal'] = createExportWrapper('ma_sound_group_config_init_2_internal');
var _ma_engine_config_init_internal = Module['_ma_engine_config_init_internal'] = createExportWrapper('ma_engine_config_init_internal');
var _ma_engine_listener_get_position_internal = Module['_ma_engine_listener_get_position_internal'] = createExportWrapper('ma_engine_listener_get_position_internal');
var _ma_engine_listener_get_direction_internal = Module['_ma_engine_listener_get_direction_internal'] = createExportWrapper('ma_engine_listener_get_direction_internal');
var _ma_engine_listener_get_velocity_internal = Module['_ma_engine_listener_get_velocity_internal'] = createExportWrapper('ma_engine_listener_get_velocity_internal');
var _ma_engine_listener_get_world_up_internal = Module['_ma_engine_listener_get_world_up_internal'] = createExportWrapper('ma_engine_listener_get_world_up_internal');
var _ma_sound_get_direction_to_listener_internal = Module['_ma_sound_get_direction_to_listener_internal'] = createExportWrapper('ma_sound_get_direction_to_listener_internal');
var _ma_sound_get_position_internal = Module['_ma_sound_get_position_internal'] = createExportWrapper('ma_sound_get_position_internal');
var _ma_sound_get_direction_internal = Module['_ma_sound_get_direction_internal'] = createExportWrapper('ma_sound_get_direction_internal');
var _ma_sound_get_velocity_internal = Module['_ma_sound_get_velocity_internal'] = createExportWrapper('ma_sound_get_velocity_internal');
var _ma_sound_group_get_direction_to_listener_internal = Module['_ma_sound_group_get_direction_to_listener_internal'] = createExportWrapper('ma_sound_group_get_direction_to_listener_internal');
var _ma_sound_group_get_position_internal = Module['_ma_sound_group_get_position_internal'] = createExportWrapper('ma_sound_group_get_position_internal');
var _ma_sound_group_get_direction_internal = Module['_ma_sound_group_get_direction_internal'] = createExportWrapper('ma_sound_group_get_direction_internal');
var _ma_sound_group_get_velocity_internal = Module['_ma_sound_group_get_velocity_internal'] = createExportWrapper('ma_sound_group_get_velocity_internal');
...
var _mono_aot_MiniAudioDemoWeb_get_method = Module['_mono_aot_MiniAudioDemoWeb_get_method'] = createExportWrapper('mono_aot_MiniAudioDemoWeb_get_method');
...
var _mono_aot_System_IO_Pipelines_get_method = Module['_mono_aot_System_IO_Pipelines_get_method'] = createExportWrapper('mono_aot_System_IO_Pipelines_get_method');
...
var _mono_aot_System_Text_Encodings_Web_get_method = Module['_mono_aot_System_Text_Encodings_Web_get_method'] = createExportWrapper('mono_aot_System_Text_Encodings_Web_get_method');
var _mono_aot_System_Text_Json_get_method = Module['_mono_aot_System_Text_Json_get_method'] = createExportWrapper('mono_aot_System_Text_Json_get_method');
...
var ___start_em_js = Module['___start_em_js'] = 3035551;
var ___stop_em_js = Module['___stop_em_js'] = 3049910;
