...
namespace Mediapipe
{
  public class ImageFrame : MpResourceHandle
  {
    ...
    public ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, SharedBuffer pixelData, Deleter deleter)
    ...
    ///   </list>
    /// </remarks>
    public ImageFrame(ImageFormat.Types.Format format, int width, int height, int widthStep, SharedBuffer pixelData)
