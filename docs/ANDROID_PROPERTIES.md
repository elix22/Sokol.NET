...
If you don't include any Android properties in `Directory.Build.props`, SokolApplicationBuilder will use sensible defaults suitable for most sokol-charp applications.
