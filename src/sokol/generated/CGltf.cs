...
#endif
public static extern cgltf_result cgltf_load_buffers(in cgltf_options options, out cgltf_data data, [M(U.LPUTF8Str)] string gltf_path);
...
#endif
public static extern cgltf_result cgltf_validate(out cgltf_data data);
...
#endif
public static extern void cgltf_free(out cgltf_data data);
...
#endif
public static extern ref byte cgltf_buffer_view_data(in cgltf_buffer_view view);
